...
export default function UploadArea({ predictionData, setPredictionData }:UploadAreaProps) {
  ...
  return (
    <section className='w-[80vw] md:w-[36rem] flex flex-col justify-center bg-altbackground rounded-2xl p-5 lg:p-6 gap-4 text-content border-black border-solid border-2 drop-shadow-customBigger hover:drop-shadow-hoverBigger transition-all duration-150'>
